...
public interface BreVocabularyService {

	@ApiOperation(value = "Returns specified vocabulary with entire name. pkg_id::obejct_name.object_suffix", httpMethod = "GET")
	...
	@ApiOperation(value = "Activates specified vocabulary with entire name. pkg_id::obejct_name.object_suffix", httpMethod = "POST")
	@ApiImplicitParams({ @ApiImplicitParam(name = "name", paramType = "query", required = true, dataType = "String") })
