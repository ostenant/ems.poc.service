...
import com.sap.csc.poc.ems.service.brm.rest.alpha.basic.fallback.BrmVocabularyServiceFallback;

/**
 * @author Vincent Chen
 *
 */
@FeignClient(name = "business-rule-service", fallback = BrmVocabularyServiceFallback.class)
