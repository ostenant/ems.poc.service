...
public interface BrmDecisionTableService {
	...
	@ApiOperation(value = "Returns specified decisiontable with entire name. pkg_id::obejct_name", httpMethod = "GET")
	...
	@ApiOperation(value = "Activates specified decisiontable with entire name. pkg_id::obejct_name", httpMethod = "POST")
	@ApiImplicitParams({ @ApiImplicitParam(name = "name", paramType = "query", required = true, dataType = "String") })
